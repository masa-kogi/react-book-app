import { TextField, Typography, Container, Grid, Box, Card, CardMedia, CardContent, CardActions, Button } from "@mui/material"
    ...
    <Container component="section" maxWidth="md" sx={{ mt: 5 }}>
      <Card sx={{ height: '100%' }}>
        <Grid container>
          ...
          <Grid item sm={8}>
            <CardContent>
              <Typography sx={{ mb: 2, fontSizd: '18px' }}>
                {book.title}
              </Typography>
              <Box sx={{ mb: 2 }}>
                読んだ日
            ...
            <CardActions>
              ...
              <Grid item sm={6}>
                <Button component={Link} to='/' color="info" variant="contained" onClick={() => updateBookInfo(book.id)}>
                  保存する
                </Button>
              </Grid>
            </CardActions>
